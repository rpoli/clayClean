            define(['react','reactViews/memberRow'], function(React, memberRow) {
               var reactComponent = React.createClass({
                        ...
                        return ({
                            ...
                            memberList : [
                                ...
                                },
                                {
                                    name : "Raju Adabala",
                                    location : "Bangalore",
                                    contact : "+91 9043443423",
                                },
                                 {
                                    name : "Raju Adabala",
                                    location : "Delhi",
                                    contact : "+91 9898983454",
                                },
                                 {
                                    name : "Raju Adabala",
                                    location : "Delhi",
                    ...
                    updateFirstChild : function(childObj, index){
                        

                        this.state.memberList[index] = childObj;
                        ...
                        return ( 
                            ...
                            <div ref="tableHeader" className="row member-table-header">
                                <div className = "col-md-11">
                                    <h3 ref="title">Executives List {this.state.title}</h3>
                                </div> 
